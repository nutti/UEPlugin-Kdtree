    ...
    namespace
    {
        ...
        void ValidateKdtree(const FKdtreeInternal& Tree, const FKdtreeNode* Node, int Depth)
        {
            ...
            if (NodeLeft)
            {
                ...
                {
                    UE_LOG(LogTemp, Error, TEXT("Kdtree is invalid: tree.Data[%d][%d](%f) < tree.Data[%d][%d](%f)"),
                           Node->Index, Axis, Tree.Data[Node->Index][Axis],
                           NodeLeft->Index, Axis, Tree.Data[NodeLeft->Index][Axis]);
                }
            }
            if (NodeRight)
            {
                if (Tree.Data[Node->Index][Axis] > Tree.Data[NodeRight->Index][Axis])
                {
                    UE_LOG(LogTemp, Error, TEXT("Kdtree is invalid: tree.Data[%d][%d](%f) > tree.Data[%d][%d](%f)"),
                           Node->Index, Axis, Tree.Data[Node->Index][Axis],
                           NodeRight->Index, Axis, Tree.Data[NodeRight->Index][Axis]);
                }
            }
        ...
        void CollectFromKdtree(const FKdtreeInternal& Tree, const FKdtreeNode* Node, const FVector& Center,
